...
/**
 * Acts as a Facade to the Tweeter server. All network requests to the server should go through his class.
 */
public class ServerFacade {
    // TODO: Set this to the invoke URL of your API. Find it by going to your API in AWS, clicking
    //  on stages in the right-side menu, and clicking on the stage you deployed your API to.
    private static final String SERVER_URL = "https://ipgwkshyf0.execute-api.us-east-2.amazonaws.com/dev";
    ...
    public LoginResponse login(LoginRequest request, String urlPath) throws IOException, TweeterRemoteException {
        ...
        //throw new TweeterRequestException("We got an error", null, null);
